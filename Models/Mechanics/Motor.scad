...
module motor_screws() {
	...
	cylinder(d = 3.2, h = motorBackplateHoleHeight + 2);
}
...
module motor_axis() {
	difference() {
		cylinder(d = motorAxisFullDiam, h = motorAxisFullLength);

		translate([motorAxisFullDiam/2 - (motorAxisFullDiam - motorAxisIndentDiam), -motorAxisFullDiam/2, motorAxisFullLength - motorAxisIndentLength])
